...
func (s *Suite) Test_Package__varuse_at_load_time(c *check.C) {
	...
	t.CheckOutputLines(
		"WARN: ~/category/pkgbase/Makefile:14: Prefer :sh instead of != for \"echo false=${FALSE:Q}\".",
		"WARN: ~/category/pkgbase/Makefile:14: To use the tool ${FALSE} at load time, bsd.prefs.mk has to be included before.",
		"WARN: ~/category/pkgbase/Makefile:15: Prefer :sh instead of != for \"echo nice=${NICE:Q}\".",
		...
		"WARN: ~/category/pkgbase/Makefile:16: Prefer :sh instead of != for \"echo true=${TRUE:Q}\".",
		"WARN: ~/category/pkgbase/Makefile:16: To use the tool ${TRUE} at load time, bsd.prefs.mk has to be included before.",
		"WARN: ~/category/pkgbase/Makefile:24: Prefer :sh instead of != for \"echo false=${FALSE:Q}\".",
		"WARN: ~/category/pkgbase/Makefile:25: Prefer :sh instead of != for \"echo nice=${NICE:Q}\".",
		"WARN: ~/category/pkgbase/Makefile:25: The tool ${NICE} cannot be used at load time.",
		"WARN: ~/category/pkgbase/Makefile:26: Prefer :sh instead of != for \"echo true=${TRUE:Q}\".")
}
