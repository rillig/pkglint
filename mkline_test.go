...
func (s *Suite) TestChecklineMkCondition(c *check.C) {
	...
	c.Check(s.Output(), equals, ""+
		...
		"WARN: fname:98: The pattern \"x86\" cannot match any of { alpha amd64 arc arm arm32 cobalt convex dreamcast evbarm hpcmips hpcsh hppa i386 ia64 m68k m88k mips mips64 mips64eb mips64el mipseb mipsel mipsn32 ns32k pc532 pmax powerpc rs6000 s390 sh3eb sh3el sparc sparc64 vax x86_64 } for MACHINE_ARCH.\n")
}
