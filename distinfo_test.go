...
func (s *Suite) Test_CheckLinesDistinfo__add_missing_hashes(c *check.C) {
	...
	t.CheckOutputLines(
		...
		"\tdownloaded to \"${PKGSRCDIR}/distfiles\". The variants are typically",
		"\tselected by setting EMUL_PLATFORM or similar variables in the",
		"\t\""+confMake+" distinfo\" command line.",
		"",
