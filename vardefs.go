...
func (reg *VarTypeRegistry) Init(src *Pkgsrc) {
	...
	reg.pkglist("PKG_LEGACY_OPTIONS", BtOption)
	reg.pkglist("PKG_OPTIONS_DEPRECATED_WARNINGS", BtShellWord)
	reg.pkglist("PKG_OPTIONS_GROUP.*", BtOption)
	reg.pkglist("PKG_OPTIONS_LEGACY_OPTS", BtUnknown)
	reg.pkglist("PKG_OPTIONS_LEGACY_VARS", BtUnknown)
	reg.pkglist("PKG_OPTIONS_NONEMPTY_SETS", BtIdentifier)
	reg.pkglist("PKG_OPTIONS_OPTIONAL_GROUPS", BtIdentifier)
	reg.pkglist("PKG_OPTIONS_REQUIRED_GROUPS", BtIdentifier)
	reg.pkglist("PKG_OPTIONS_SET.*", BtOption)
