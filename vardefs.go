...
func (gd *GlobalData) InitVartypes() {
	...
	acl("BOOTSTRAP_DEPENDS", lkSpace, CheckvarDependencyWithPath, "Makefile.common:append", "Makefile:append", "options.mk:append", "*.mk:append")
	...
	acl("BUILDLINK_LDADD.*", lkShell, CheckvarLdFlag, "builtin.mk:set,default,append,use", "buildlink3.mk:append", "Makefile:use", "Makefile.common:use", "*.mk:use")
	...
	acl("BUILDLINK_PASSTHRU_DIRS", lkShell, CheckvarPathname, "Makefile:append", "Makefile.common:append", "buildlink3.mk:append", "hacks.mk:append")
	acl("BUILDLINK_PASSTHRU_RPATHDIRS", lkShell, CheckvarPathname, "Makefile:append", "Makefile.common:append", "buildlink3.mk:append", "hacks.mk:append")
	acl("BUILDLINK_PKGSRCDIR.*", lkNone, CheckvarRelativePkgDir, "buildlink3.mk:default,use-loadtime")
	acl("BUILDLINK_PREFIX.*", lkNone, CheckvarPathname, "builtin.mk:set,use", "buildlink3.mk:", "Makefile:use", "Makefile.common:use", "*.mk:use")
	acl("BUILDLINK_RPATHDIRS.*", lkShell, CheckvarPathname, "buildlink3.mk:append")
	acl("BUILDLINK_TARGETS", lkShell, CheckvarIdentifier)
	acl("BUILDLINK_FNAME_TRANSFORM.*", lkNone, CheckvarSedCommands, "Makefile:append", "builtin.mk:append", "hacks.mk:append", "buildlink3.mk:append")
	...
	acl("BUILD_DEFS", lkShell, CheckvarVarname, "Makefile:append", "Makefile.common:append", "options.mk:append")
	acl("BUILD_DEPENDS", lkSpace, CheckvarDependencyWithPath, "Makefile.common:append", "Makefile:append", "options.mk:append", "*.mk:append")
	...
	acl("COMMENT", lkNone, CheckvarComment, "Makefile:set,append", "Makefile.common:set,append")
	...
	acl("CONFIGURE_ENV", lkShell, CheckvarShellWord, "Makefile:append,set,use", "Makefile.common:append,set,use", "buildlink3.mk:append", "builtin.mk:append", "*.mk:append,use")
	...
	acl("CONFIG_GUESS_OVERRIDE", lkShell, CheckvarPathmask, "Makefile:set,append", "Makefile.common:set,append")
	acl("CONFIG_STATUS_OVERRIDE", lkShell, CheckvarPathmask, "Makefile:set,append", "Makefile.common:set,append")
	acl("CONFIG_SHELL", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	acl("CONFIG_SUB_OVERRIDE", lkShell, CheckvarPathmask, "Makefile:set,append", "Makefile.common:set,append")
	...
	acl("DESTDIR_VARNAME", lkNone, CheckvarVarname, "Makefile:set", "Makefile.common:set")
	...
	acl("DL_AUTO_VARS", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set", "options.mk:set")
	...
	acl("EMACS_MODULES", lkShell, CheckvarIdentifier, "Makefile:set,append", "Makefile.common:set,append")
	...
	acl("EVAL_PREFIX", lkSpace, CheckvarShellWord, "Makefile:append", "Makefile.common:append") // XXX: Combining ShellWord with lkSpace looks weird.
	...
	acl("EXTRACT_OPTS", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_BIN", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_LHA", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_PAX", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_RAR", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_TAR", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_ZIP", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	acl("EXTRACT_OPTS_ZOO", lkShell, CheckvarShellWord, "Makefile:set,append", "Makefile.common:set,append")
	...
	acl("GNU_CONFIGURE", lkNone, CheckvarYes, "Makefile.common:set", "Makefile:set")
	acl("GNU_CONFIGURE_INFODIR", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	acl("GNU_CONFIGURE_LIBDIR", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	pkg("GNU_CONFIGURE_LIBSUBDIR", lkNone, CheckvarPathname)
	acl("GNU_CONFIGURE_MANDIR", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	acl("GNU_CONFIGURE_PREFIX", lkNone, CheckvarPathname, "Makefile:set")
	acl("HAS_CONFIGURE", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set")
	...
	acl("LICENCE", lkNone, CheckvarLicense, "Makefile:set", "Makefile.common:set", "options.mk:set")
	acl("LICENSE", lkNone, CheckvarLicense, "Makefile:set", "Makefile.common:set", "options.mk:set")
	...
	acl("NO_BIN_ON_CDROM", lkNone, CheckvarRestricted, "Makefile:set", "Makefile.common:set")
	acl("NO_BIN_ON_FTP", lkNone, CheckvarRestricted, "Makefile:set", "Makefile.common:set")
	acl("NO_BUILD", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set", "Makefile.*:default,set")
	...
	acl("NO_SRC_ON_CDROM", lkNone, CheckvarRestricted, "Makefile:set", "Makefile.common:set")
	acl("NO_SRC_ON_FTP", lkNone, CheckvarRestricted, "Makefile:set", "Makefile.common:set")
	...
	acl("OPSYSVARS", lkShell, CheckvarVarname, "Makefile:append", "Makefile.common:append")
	acl("OSVERSION_SPECIFIC", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set")
	...
	acl("PATCH_DIST_STRIP*", lkNone, CheckvarShellWord, "Makefile:set", "Makefile.common:set", "buildlink3.mk:", "builtin.mk:", "*.mk:set")
	...
	acl("PKG_DESTDIR_SUPPORT", lkShell, enum("destdir user-destdir"), "Makefile:set", "Makefile.common:set")
	...
	acl("PKG_OPTIONS_LEGACY_OPTS", lkSpace, CheckvarUnchecked, "Makefile:append", "Makefile.common:append", "options.mk:append")
	acl("PKG_OPTIONS_LEGACY_VARS", lkSpace, CheckvarUnchecked, "Makefile:append", "Makefile.common:append", "options.mk:append")
	...
	acl("PKG_OPTIONS_VAR", lkNone, CheckvarPkgOptionsVar, "options.mk:set", "Makefile:set", "Makefile.common:set", "bsd.options.mk:use-loadtime")
	acl("PKG_PRESERVE", lkNone, CheckvarYes, "Makefile:set")
	acl("PKG_SHELL", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	acl("PKG_SHELL.*", lkNone, CheckvarPathname, "Makefile:set", "Makefile.common:set")
	...
	acl("PKG_USE_KERBEROS", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set")
	...
	acl("PYPKGPREFIX", lkNone, enum("py27 py33 py34"), "*:use-loadtime,use", "pyversion.mk:set", "*:")
	...
	acl("REPLACE_FILES.*", lkShell, CheckvarPathmask, "Makefile:set,append", "Makefile.common:set,append")
	acl("REPLACE_INTERPRETER", lkShell, CheckvarIdentifier, "Makefile:append", "Makefile.common:append")
	...
	acl("SITES.*", lkShell, CheckvarFetchURL, "Makefile:set,append,use", "Makefile.common:set,append,use", "options.mk:set,append,use")
	...
	acl("SUBST_FILES.*", lkShell, CheckvarPathmask, "Makefile:set,append", "Makefile.*:set,append", "*.mk:set,append")
	acl("SUBST_FILTER_CMD.*", lkNone, CheckvarShellCommand, "Makefile:set", "Makefile.*:set", "*.mk:set")
	acl("SUBST_MESSAGE.*", lkNone, CheckvarMessage, "Makefile:set", "Makefile.*:set", "*.mk:set")
	acl("SUBST_SED.*", lkNone, CheckvarSedCommands, "Makefile:set,append", "Makefile.*:set,append", "*.mk:set,append")
	...
	acl("TEX_ACCEPTED", lkShell, enum("teTeX1 teTeX2 teTeX3"), "Makefile:set", "Makefile.common:set")
	acl("TEX_DEPMETHOD", lkNone, enum("build run"), "Makefile:set", "Makefile.common:set")
	pkglist("TEXINFO_REQD", lkShell, CheckvarVersion)
	acl("TOOL_DEPENDS", lkSpace, CheckvarDependencyWithPath, "Makefile.common:append", "Makefile:append", "options.mk:append", "*.mk:append")
	...
	acl("USE_GNU_ICONV", lkNone, CheckvarYes, "Makefile:set", "Makefile.common:set", "options.mk:set")
	...
	acl("USE_LANGUAGES", lkShell, enum("ada c c99 c++ fortran fortran77 java objc"), "Makefile:set", "Makefile.common:set", "options.mk:set")
	...
	acl("WRAPPER_REORDER_CMDS", lkShell, CheckvarWrapperReorder, "buildlink3.mk:append", "Makefile.common:append", "Makefile:append")
	acl("WRAPPER_TRANSFORM_CMDS", lkShell, CheckvarWrapperTransform, "buildlink3.mk:append", "Makefile.common:append", "Makefile:append")
...
func parseAclEntries(varname string, args []string) []AclEntry {
	var result []AclEntry
...
func pkglist(varname string, kindOfList KindOfList, checker *VarChecker) {
	acl(varname, kindOfList, checker, "Makefile:append,set,use", "Makefile.common:append,set,use", "buildlink3.mk:", "builtin.mk:", "*.mk:append,use")
}
...
func sys(varname string, kindOfList KindOfList, checker *VarChecker) {
	acl(varname, kindOfList, checker, "buildlink3.mk:", "builtin.mk:use", "*:use")
}
...
func bl3list(varname string, kindOfList KindOfList, checker *VarChecker) {
	acl(varname, kindOfList, checker, "buildlink3.mk:append", "builtin.mk:append")
}
