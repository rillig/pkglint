...
func (gd *GlobalData) InitVartypes() {
	...
	acl("BUILDLINK_ABI_DEPENDS.*", lkSpace, CheckvarDependency, "builtin.mk: use-loadtime; *: append")
	acl("BUILDLINK_API_DEPENDS.*", lkSpace, CheckvarDependency, "builtin.mk: use-loadtime; *: append")
