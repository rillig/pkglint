...
func (gd *GlobalData) InitVartypes() {
	...
	usr("DEFAULT_VIEW", lkNone, BtUnchecked)
	...
	usr("MASTER_SORT", lkShell, BtUnchecked)
	usr("MASTER_SORT_REGEX", lkShell, BtUnchecked)
	...
	acl("BDB185_DEFAULT", lkNone, BtUnchecked, "")
	...
	acl("BUILTIN_FIND_GREP.*", lkNone, BtString, "builtin.mk: set")
	...
	acl("BUILTIN_IMAKE_CHECK", lkShell, BtUnchecked, "builtin.mk: set")
	acl("BUILTIN_IMAKE_CHECK.*", lkNone, BtYesNo, "")
	sys("BUILTIN_X11_TYPE", lkNone, BtUnchecked)
	sys("BUILTIN_X11_VERSION", lkNone, BtUnchecked)
	...
	acl("LICENCE", lkNone, BtLicense, "Makefile, Makefile.common, options.mk: set")
	acl("LICENSE", lkNone, BtLicense, "Makefile, Makefile.common, options.mk: set")
	...
	acl("PKGREPOSITORY", lkNone, BtUnchecked, "")
	...
	acl("PKG_OPTIONS_LEGACY_OPTS", lkSpace, BtUnchecked, "Makefile, Makefile.common, options.mk: append")
	acl("PKG_OPTIONS_LEGACY_VARS", lkSpace, BtUnchecked, "Makefile, Makefile.common, options.mk: append")
	...
	acl("REPLACE.*", lkNone, BtString, "Makefile: set")
