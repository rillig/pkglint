...
func (s *Suite) Test_Pkgsrc_loadDocChangesFromFile__default(c *check.C) {
	...
	t.CheckOutputLines(
		...
		"1 warning found.",
		"(Run \"pkglint -e ~/category/package\" to show explanations.)")
	...
	t.CheckOutputLines(
		...
		"4 warnings found.",
		"(Run \"pkglint -e -Cglobal -Wall ~\" to show explanations.)")
}
...
func (s *Suite) Test_Pkgsrc_loadDocChangesFromFile__wrong_indentation(c *check.C) {
	...
	t.CheckOutputLines(
		...
		"2 warnings found.",
		"(Run \"pkglint -e -Cglobal -Wall ~/category/package\" to show explanations.)")
}
...
func (s *Suite) Test_Pkgsrc_VariableType__from_mk(c *check.C) {
	...
	t.CheckOutputLines(
		...
		"2 warnings found.",
		"(Run \"pkglint -e -Wall ~/category/package\" to show explanations.)")
}
