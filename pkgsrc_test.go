...
func (s *Suite) Test_Pkgsrc_loadTools(c *check.C) {
	...
	t.CheckOutputLines(
		"TRACE: + (*Tools).Trace()",
		"TRACE: 1   tool &{Name:bzcat Varname: MustUseVarForm:false Validity:NeverValid}",
		"TRACE: 1   tool &{Name:bzip2 Varname: MustUseVarForm:false Validity:NeverValid}",
		"TRACE: 1   tool &{Name:chown Varname:CHOWN MustUseVarForm:false Validity:NeverValid}",
		...
		"TRACE: 1   tool &{Name:false Varname:FALSE MustUseVarForm:true Validity:NeverValid}",
		"TRACE: 1   tool &{Name:gawk Varname:AWK MustUseVarForm:false Validity:NeverValid}",
		"TRACE: 1   tool &{Name:m4 Varname: MustUseVarForm:false Validity:AfterPrefsMk}",
		"TRACE: 1   tool &{Name:msgfmt Varname: MustUseVarForm:false Validity:NeverValid}",
		"TRACE: 1   tool &{Name:mv Varname:MV MustUseVarForm:false Validity:NeverValid}",
		"TRACE: 1   tool &{Name:pwd Varname:PWD MustUseVarForm:false Validity:AfterPrefsMk}",
		"TRACE: 1   tool &{Name:strip Varname: MustUseVarForm:false Validity:NeverValid}",
