...
func (s *Suite) Test_NewPlistRank(c *check.C) {
	...
	//      5 PLIST.cocoa
	//      5 PLIST.IRIX
	//      4 PLIST.solaris-x86_64
	//      4 PLIST.shared
	//      4 PLIST.alsa
	//      4 PLIST.a.out
	//      3 PLIST.x11
	//      3 PLIST.solaris-i386
	//      3 PLIST.opt
	//      3 PLIST.mipseb
	//      3 PLIST.lightning
	//      3 PLIST.ldap
	...
	//      2 PLIST.cons.saver
	//      2 PLIST.charset
	//      2 PLIST.Linux-x86_64
	//      2 PLIST.Darwin-x86_64
	//      1 PLIST.xjed
	//      1 PLIST.x68k
	//      1 PLIST.wv
	//      1 PLIST.webcollage
	...
	//      1 PLIST.gui
	//      1 PLIST.gtkspell
	//      1 PLIST.gtksourceview2
	//      1 PLIST.gtksourceview
	//      1 PLIST.gps
	//      1 PLIST.gnomepanel
	//      1 PLIST.gnomecanvas
	//      1 PLIST.gmdb
